...
$Logfile = "C:\Windows\Temp\Remediate_BranchCache_CacheSize.log"
...
Write-Output "Cache size should be: $CacheSize %"
...
Write-OUtput "BC Cache Size Remediation is Completed"